...
// +----------------------------------------------------------------------
// | Author: 兜兜虫科技 <http://www.doudouchongkeji.com>
// +----------------------------------------------------------------------
// error_reporting(E_ALL & ~E_NOTICE);//关闭为定义变量错误警告
error_reporting(E_ALL);//关闭为定义变量错误警告
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'W!/}"&^Oz0kgaf`2+,EA4;YXRt$(qws1D{-Gmy7u', //默认数据加密KEY
	'data_cache_key'=> 'W!/}"&^Oz0kgaf`2+,EA4;YXRt$(qws1D{-Gmy7u',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'W!/}"&^Oz0kgaf`2+,EA4;YXRt$(qws1D{-Gmy7u', //加密KEY
...
/*-------------------------------------------------完美分割线-------------------------------------------------*/
    ...
    'message'               => [
        ...
        // 加密
        'encrypt' => 'MDAwMDAwMDAwMH-uq9t9mKFy',
    ],
];
