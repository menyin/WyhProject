...
;(function (factory) {
    ...
    $.fn.citys = function(parameter,getApi) {
        ...
        var defaults = {
//!--var province_id = {$areaInfo.province_id}; // 当前省份ID
//var city_id = {$areaInfo.city_id}; // 当前城市ID
//var provinces = {:getProvinces()}; // 所有省份
//var cities = {:getCities('province_id')}; // 所有城市
//var areas = {:getAreas('city_id')}; // 所有地区-->
